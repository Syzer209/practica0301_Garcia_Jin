...
def check_DGT(ruta):
    ...
    with open("C:/Users/Dell/OneDrive/Escritorio/Dapi/GitHub/practica0301_Garcia_Jin/50.csv", 'w', encoding='utf-8',
              newline='') as csvfille:
...
check_DGT("C:/Users/Dell/OneDrive/Escritorio/Dapi/GitHub/practica0301_Garcia_Jin/50.csv")